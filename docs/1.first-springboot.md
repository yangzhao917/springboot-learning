...
> 摘要（TL;DR）
> - 目标：用最少步骤跑通第一个 Spring Boot 应用
> - 学会：项目结构、起步依赖、启动类、Controller 与配置文件
> - 收获：可运行的 Demo + 基本调试与常见问题定位
...
- [项目结构一览](#项目结构一览)
- [🚀 快速体验](#快速体验)
- [1️⃣ 配置 Maven 依赖 (pom.xml)](#1️⃣-配置-maven-依赖-pomxml)
- [2️⃣ 创建启动类 (Application)](#2️⃣-创建启动类-application)
- [3️⃣ 创建控制器 (Controller)](#3️⃣-创建控制器-controller)
- [4️⃣ 配置文件管理](#4️⃣-配置文件管理)
- [🎁 起步依赖详解](#-起步依赖详解)
- [🚀 快速上手实践](#-快速上手实践)
- [🎯 下一步学习](#-下一步学习)
- [❓ 常见问题](#-常见问题)
